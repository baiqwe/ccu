...
export default async function PrivacyPage({ params: { locale } }: { params: { locale: string } }) {
    ...
    return (
        <main className="min-h-screen bg-slate-50">
            ...
            {/* Header Section */}
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border-b border-slate-200">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 space-y-12">
                        ...
                        <section>
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-2xl font-bold text-slate-900 mb-3">{t('section5Title')}</h2>
                                    <p className="text-slate-600 leading-relaxed">{t('section5Content')}</p>
                                </div>
                            </div>
                        </section>
                    </div>
