...
export default async function AboutPage({ params: { locale } }: { params: { locale: string } }) {
    ...
    return (
        <main className="min-h-screen bg-slate-50">
            ...
            {/* Header Section */}
            <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 border-b border-slate-200">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 space-y-12">
                        <section className="border-b border-slate-100 pb-8 last:border-0">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-600 leading-relaxed">{t('missionContent')}</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="border-b border-slate-100 pb-8 last:border-0">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-2xl font-bold text-slate-900 mb-3">{t('storyTitle')}</h2>
                                    <p className="text-slate-600 leading-relaxed">{t('storyContent')}</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="border-b border-slate-100 pb-8 last:border-0">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-2xl font-bold text-slate-900 mb-3">{t('whyFreeTitle')}</h2>
                                    <p className="text-slate-600 leading-relaxed">{t('whyFreeContent')}</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="border-b border-slate-100 pb-8 last:border-0">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-2xl font-bold text-slate-900 mb-3">{t('technologyTitle')}</h2>
                                    <p className="text-slate-600 leading-relaxed">{t('technologyContent')}</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-600 leading-relaxed">{t('contactContent')}</p>
                                </div>
                            </div>
                        </section>
                    </div>
